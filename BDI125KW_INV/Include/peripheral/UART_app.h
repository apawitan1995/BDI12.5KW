...
extern volatile int32_t string_read_xmc_increment;
extern volatile char string_read_xmc[64];
extern volatile int32_t flag_update_send_xmc;
extern volatile int32_t flag_update_receive_xmc;
extern volatile int32_t data_uart_xmc[16];
